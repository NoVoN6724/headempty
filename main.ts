...
if (A1 == 1) {
    ...
    mySprite2 = sprites.create(img`
        ...
        ................................
        `, SpriteKind.Food)
    mySprite2.setPosition(86, 97)
    game.showLongText("you found a fully cooked ham! Would you like to eat it (1) or leave it alone (2)", DialogLayout.Top)
    AA1 = game.askForNumber("", 1)
    if (AA1 == 1) {
        ...
        mySprite3 = sprites.create(img`
            ...
            6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 6 
            `, SpriteKind.object2)
        mySprite3.setPosition(86, 97)
        game.showLongText("It was a landmine that exploded and revieled the entrance to a secret bunker. you go inside", DialogLayout.Top)
        mySprite.setPosition(71, 97)
        pause(500)
        scene.setBackgroundImage(img`
            ...
            `)
        game.showLongText("You find yourself in the underworld. Would you like to head to the castle (1) or fend for yourself in the wild (2)", DialogLayout.Top)
        AAA1 = game.askForNumber("", 1)
        if (AAA1 == 1) {
            scene.setBackgroundImage(img`
            ...
            king_guy = sprites.create(img`
                ...
                ........................................
                `, SpriteKind.Player)
            king_guy.setPosition(131, 89)
            game.showLongText("You've found the king. Would you like to attack him (1) or befriend him (2).", DialogLayout.Top)
            AAAA1 = game.askForNumber("")
            if (AAAA1 == 1) {
                king_guy.sayText("then perish")
                king_guy = sprites.create(img`
                    ........................................
                    ........................................
                    ........................................
                ...
                KnightSprite = sprites.create(img`
                    ...
                    .........................
                    `, SpriteKind.Player)
                KnightSprite.setPosition(29, 105)
                mySprite.destroy()
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    game.showLongText("you've constructed an igloo. would you like to do some interior decorating (1) or investigate the loud roar in the distance (2)", DialogLayout.Top)
    BB1 = game.askForNumber("", 1)
    if (BB1 == 1) {
        scene.setBackgroundImage(img`
            ...
            `)
        game.showLongText("It is pretty nice in here. You decide to stay and live in the wilds.", DialogLayout.Top)
        pause(1000)
        game.over(true)
    } else if (BB1 == 2) {
        scene.setBackgroundImage(img`
        ...
        Godzilla = sprites.create(img`
            ...
            ...............................................................ccccc..ccc....
            `, SpriteKind.Projectile)
        Godzilla.setPosition(138, 88)
        game.showLongText("Wow its a monster. Do you want to fight it (1) or befriend it (2)", DialogLayout.Top)
        BBB1 = game.askForNumber("", 1)
        if (BBB1 == 1) {
            ...
            mySprite.setPosition(136, 41)
            game.showLongText("You and your friend reign supreme over the forest.", DialogLayout.Bottom)
            pause(2000)
            game.over(true)
        } else {
            ehh()
